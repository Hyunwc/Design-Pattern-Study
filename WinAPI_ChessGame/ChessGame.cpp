// ChessGame.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
    ...
    _In_ int       nCmdShow)
{
   ...
   // LoadStringW(hInstance, IDC_CHESSGAME, szWindowClass, MAX_LOADSTRING);
    ...
    //ACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CHESSGAME));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    HWND hWnd = CreateWindowW(IpszClass, IpszClass, WS_SYSMENU | WS_MINIMIZEBOX,
        CW_USEDEFAULT, CW_USEDEFAULT, 615, 700, nullptr, nullptr, hInstance, nullptr);
